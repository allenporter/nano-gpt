...
def get_data_loader(
    enc: Any, batch_size: int, token_len: int, device: Any
) -> Iterator[tuple[torch.Tensor, torch.Tensor]]:
    """Get the data loader."""
    return DataLoader(enc, batch_size, token_len, device)
...
class DataLoader:
    ...
    def __init__(
        self, enc: Tokenizer, batch_size: int, token_len: int, device: Any
    ) -> None:
